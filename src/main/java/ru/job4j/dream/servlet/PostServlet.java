 ...
 * @since 25.06.2021
 * @version 1.0
 * Принцип работы - выводится в браузере файл index.jsp - далее newVacancy.jsp - вводим имя и описание новой заявки
...
public class PostServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Store.instOf().save(new Post(answer[0], 0, answer[1], LocalDate.now()));
